        ...
        <>
            <div id="about" className="relative head-top min-h-[60vh] bg-black text-white flex justify-center items-center">
                ...
                <div className='relative max-w-6xl mx-auto'>
                    <div className='text-3xl md:text-[5rem] xl:text-[6rem] font-semibold blend mb-6 xl:mb-12 text-center '>Frequently <span className='text-fodOrange'>Asked</span> Questions</div>
